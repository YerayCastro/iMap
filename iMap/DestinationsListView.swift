...
//  iMap
//
//  Created by Yery Castro on 23/4/24.
//
            ...
            Group {
                if !destinations.isEmpty {
                        ...
                        NavigationLink(value: destination) {
                            HStack {
                                ...
                                VStack(alignment: .leading) {
                                    ...
                                    Text("^[\(destination.placemarks.count) locations](inflect: true)")
                                        .font(.caption)
                    ...
                    ContentUnavailableView("No Destinations",
                                           ...
                                           description: Text("You have not set up ani destinations yet. Tap on the button in the toolbar to begin."))
                }
            }
